...
function displayUsers(){
   ...
   for($i=0; $i<$num_rows; $i++){
      ...
      echo "<tr><td>$uname</td><td>$ulevel</td><td>$email</td><td>$time</td><td><a href=\"deleteuser.php?id=$uname&time=$time\" title=\"Delete this user\" target=\"_top\">Delete</a></td></tr>\n";
   }
   echo "</table><br>\n";
}
...
?>
<html>
<title>SiteSonar.net Admin Page</title>
<body>
<h1>Admin Center</h1>
<p><font size="5" color="#ff0000">
  <b>::::::::::::::::::::::::::::::::::::::::::::</b></font>
    <font size="4">Logged in as <b><?php echo $session->username; ?></b></font><br>
  <br>
Back to [<a href="../control panel/main.php">Main Page</a>]</p>
<p><a href="check_sites_status.php" target="_blank">Click here</a> to manage all sites. <a href="cleanRecentStatuses.php" target="_blank">Click here</a> to clean status_records table.<br>
  <br>
  <?php
